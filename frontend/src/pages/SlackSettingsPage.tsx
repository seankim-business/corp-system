...
export default function SlackSettingsPage() {
  ...
  useEffect(() => {
    ...
    if (success === "true") {
      ...
      const errorMessages: Record<string, string> = {
        ...
        slack_not_configured: "Slack integration is not yet configured. Please contact support.",
      };
  ...
  const isConnected = !!(integration?.hasWorkspace && integration?.workspaceId);
        ...
        {isConnected && integration ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              ...
              Your team will be able to interact with AI agents directly from Slack.
            </p>
            <button
              onClick={handleConnectSlack}
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#4A154B] text-white rounded-lg hover:bg-[#3e1240] transition-colors font-medium text-lg"
            >
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Click "Connect to Slack" and authorize Nubabel in your workspace.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="font-medium text-gray-900">Invite the bot to channels</h4>
              <p className="text-sm text-gray-600">
                Add the Nubabel bot to the channels where you want AI assistance.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="font-medium text-gray-900">Start using AI automation</h4>
              <p className="text-sm text-gray-600">
                Mention the bot or use slash commands to interact with your AI agents.
              </p>
            </div>
          </div>
        </div>
